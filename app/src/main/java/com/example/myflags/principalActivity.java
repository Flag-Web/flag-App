        ...
        menuLay.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id== R.id.men4){
                    ...
                    Intent intent=new Intent(principalActivity.this,Profil.class);
                    startActivity(intent);
                    return true;
                }
                else if(id== R.id.men2){
                    Intent intent=new Intent(principalActivity.this,Param.class);
                    startActivity(intent);
                    return true;
                }
                else if(id== R.id.men3){
                    Intent intent=new Intent(principalActivity.this,Info.class);
                    startActivity(intent);
                    return true;
                }
